...
<x-default-layout>
    <!-- Contenu - Main -->
      ...
      <section class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div class="bg-white shadow rounded-lg p-6 border-l-4 border-red-600">
            <h3 class="text-gray-600">Nombre de Cours</h3>
            <p class="mt-2 text-2xl font-bold">12</p>
          </div>
          <div class="bg-white shadow rounded-lg p-6 border-l-4 border-red-600">
            <h3 class="text-gray-600">Cours en Cours</h3>
            <p class="mt-2 text-2xl font-bold">3</p>
          </div>
          <div class="bg-white shadow rounded-lg p-6 border-l-4 border-red-600">
            <h3 class="text-gray-600">Certifications</h3>
            <p class="mt-2 text-2xl font-bold">5</p>
          </div>
          <div class="bg-white shadow rounded-lg p-6 border-l-4 border-red-600">
            <h3 class="text-gray-600">Heures d'Étude</h3>
      ...
      <!-- Section Mes Cours -->
      <section class="mb-8">
        <h2 class="text-xl font-semibold text-gray-700 mb-4">Mes Cours</h2>
